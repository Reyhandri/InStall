        ...
        <ul class="navbar-nav ms-auto">
          ...
          <?php
              if (isset($_SESSION['id_jenis']) && $_SESSION['id_jenis'] == TRUE) {
                ...
                if ($jenis == 2) {
                  echo " <a class='nav-link' aria-current='page' href='../investor/investor.php'>Beranda</a>
                  ";
                } else if ($jenis == 4){
                  echo " <a class='nav-link' aria-current='page' href='../index.php'>Beranda</a>
                  ";
                }
              }
          ?>
          ...
          <?php
              if (isset($_SESSION['id_jenis']) && $_SESSION['id_jenis'] == TRUE) {
                ...
                if ($jenis == 2 || $jenis == 4) {
                  echo "
                          <a class='nav-link' href='#' style='color: white;'>Histori</a>
                        ";
                } else if ($jenis == 3) {
                  echo "
                          <a class='nav-link' href='#' style='color: black;'>Bisnis Anda</a>
                          <li>
